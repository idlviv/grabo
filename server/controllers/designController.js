...
module.exports.designAddImagesBatch = function(req, res, next) {
  let form = new formidable.IncomingForm({maxFileSize: 10485760, maxFields : 50}); //10 * 1024 * 1024
  let receivedFiles = [];
...
module.exports.designAddImage = function(req, res, next) {
  ...
  form.parse(req, function(err, fields, files) {
    ...
    console.log('batch images files', util.inspect(files, {showHidden: false, depth: null}));
