...
var UserCreateComponent = /** @class */ (function () {
    ...
    UserCreateComponent.prototype.onUserCreateFake = function () {
        var _this = this;
        this.user = {
            login: 'tlogjygtr',
            password: 'password',
