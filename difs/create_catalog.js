...
.insertMany([
  { _id: 'home', name: 'Головна', ancestors: [], parent: 'null',
    auth: 'casual', order: 0, assets: ['./assets/images/default-product180x180.png'], description: ''},
    {_id:'common', name:'Загальні', ancestors:['home'], parent :'home',
      auth: 'casual', order:1, assets:['./assets/images/default-product180x180.png'], description:''},
      ...
      { _id: 'products', name: 'Каталог', ancestors: ['home', 'common'], parent: 'common',
        ...
        { _id: 'basic', name: 'Побутовий лінолеум', ancestors: ['home', 'common', 'products'], parent: 'products',
          auth: 'casual', order: 1, prefix: '', assets: ['./assets/images/default-product180x180.png'], description: ''},
        ...
        { _id: 'semi_commercial', name: 'Напівкомерційний лінолеум', ancestors: ['home', 'common', 'products'], parent: 'products',
          auth: 'casual', order: 2, prefix: '', assets: ['./assets/images/default-product180x180.png'], description: ''},
          { _id: 'astral_color', name: 'Astra color', ancestors: ['home', 'common', 'products', 'semi_commercial'], parent: 'semi_commercial',
            auth: 'casual', order: 2, prefix: '', assets: ['./assets/images/default-product180x180.png'], description: ''},
        ...
        { _id: 'parquet', name: 'Паркет', ancestors: ['home', 'common', 'products'], parent: 'products',
          auth: 'casual', order: 3, prefix: '', assets: ['./assets/images/default-product180x180.png'], description: ''},

        { _id: 'commercial', name: 'Комерційний лінолеум', ancestors: ['home', 'common', 'products'], parent: 'products',
          auth: 'casual', order: 4, prefix: '', assets: ['./assets/images/default-product180x180.png'], description: ''},
          ...
          { _id: 'fortis', name: 'Fortis', ancestors: ['home', 'common', 'products', 'commercial'], parent: 'commercial',
            auth: 'casual', order: 5, prefix: '', assets: ['./assets/images/default-product180x180.png'], description: ''},
        ...
        { _id: 'show', name: 'Сценічний лінолеум', ancestors: ['home', 'common', 'products'], parent: 'products',
          auth: 'casual', order: 6, prefix: '', assets: ['./assets/images/default-product180x180.png'], description: ''},
      ...
      { _id: 'gallery', name: 'Галерея', ancestors: ['home', 'common'], parent: 'common',
        auth: 'casual', order: 2, assets: ['./assets/images/default-product180x180.png'], description: ''},
      { _id: 'downloads', name: 'Завантаження', ancestors: ['home', 'common'], parent: 'common',
        auth: 'casual', order: 3, assets: ['./assets/images/default-product180x180.png'], description: ''},
      { _id: 'become_dealer', name: 'Стати дилером', ancestors: ['home', 'common'], parent: 'common',
        auth: 'casual', order: 4, assets: ['./assets/images/default-product180x180.png'], description: ''},
      { _id: 'contacts', name: 'Контакти', ancestors: ['home', 'common'], parent: 'common',
        auth: 'casual', order: 5, assets: ['./assets/images/default-product180x180.png'], description: ''},
      { _id: 'info', name: 'Про нас', ancestors: ['home', 'common'], parent: 'common',
        auth: 'casual', order: 6, assets: ['./assets/images/default-product180x180.png'], description: ''},

    {_id: 'system', name:'Система', ancestors: ['home'], parent :'home',
      auth: 'guest', order: 2, assets:['./assets/images/default-product180x180.png'], description:''},

      {_id: 'dashboard', name:'Dashboard', ancestors: ['home', 'system'], parent :'system',
        auth: 'guest', order: 1, assets:['./assets/images/default-product180x180.png'],  description:''},
        {_id: 'profile', name: 'Профіль', ancestors: ['home', 'system', 'dashboard'], parent: 'dashboard',
          auth: 'guest', order: 1, assets: ['./assets/images/default-product180x180.png'], description: ''},
        {_id: 'product_create', name: 'Додати виріб', ancestors: ['home', 'system', 'dashboard'], parent: 'dashboard',
          auth: 'manager', order: 2, assets: ['./assets/images/default-product180x180.png'],  description: ''},
        {_id: 'product_edit', name: 'Редагувати виріб', ancestors: ['home', 'system', 'dashboard'], parent: 'dashboard',
          auth: 'manager', order: 3, assets: ['./assets/images/default-product180x180.png'], description: ''},
